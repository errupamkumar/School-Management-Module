...
<p align="center">
  <img src="docs/screenshots/02_admin_dashboard_modern.png" width="48%" alt="Modern Dashboard View" />
  <img src="docs/screenshots/03_admin_dashboard_classic.png" width="48%" alt="Classic Dashboard View" />
</p>
<p align="center">
...
| :---: | :---: |
| <img src="docs/screenshots/01_login_page.png" width="450" alt="Login Page" /> | <img src="docs/screenshots/05_new_admission.png" width="450" alt="Admission Portal" /> |
...
| :---: | :---: |
| <img src="docs/screenshots/04_student_management.png" width="450" alt="Student Management" /> | <img src="docs/screenshots/08_attendance_management.png" width="450" alt="Attendance Management" /> |
...
| :---: | :---: |
| <img src="docs/screenshots/06_fee_collection.png" width="450" alt="Fee Collection" /> | <img src="docs/screenshots/07_fee_dues.png" width="450" alt="Fee Dues" /> |
...
| :---: | :---: |
| <img src="docs/screenshots/09_exam_management.png" width="450" alt="Exam Management" /> | <img src="docs/screenshots/10_notifications_center.png" width="450" alt="Notifications Center" /> |
...
| :---: |
| <img src="docs/screenshots/11_school_chat.png" width="900" alt="School Chat" /> |
...
| :---: | :---: | :---: |
| <img src="docs/screenshots/12_teacher_dashboard.png" width="300" alt="Teacher Dashboard" /> | <img src="docs/screenshots/13_parent_portal.png" width="300" alt="Parent Portal" /> | <img src="docs/screenshots/14_student_portal.png" width="300" alt="Student Portal" /> |
...
```mermaid
graph TD
    Client[Client Browser / Mobile PWA] --> NextApp[Next.js 14 App Router]
    
    subgraph Frontend Layer
        NextApp --> React[React 18 & TypeScript]
        NextApp --> Tailwind[Tailwind CSS & Lucide Icons]
        NextApp --> Recharts[Recharts Analytics]
        NextApp --> ExportEngines[jsPDF & SheetJS / xlsx]
    end
    
    subgraph Application & Security
        NextApp --> NextAuth[NextAuth.js Session & RBAC]
        NextApp --> Zod[Zod Schema Validation]
        NextApp --> Mailer[Nodemailer SMTP & SMS Gateway]
    end
    
    subgraph Data & ORM Layer
        NextApp --> Prisma[Prisma ORM Client]
        Prisma --> Database[(PostgreSQL / MySQL Server)]
    end
```
